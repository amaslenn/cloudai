...
def register_all():
    ...
    from cloudai.reporter import NotebookReport, PerTestReporter, StatusReporter, TarballReporter
    ...
    Registry().add_scenario_report("notebook", NotebookReport, ReportConfig(enable=True))
