...
class NotebookReport(Reporter):
    """Generates a notebook of test results."""
    ...
    def generate(self) -> None:
        ...
        notebook_content = template.render(test_scenario=self.test_scenario, tr_results=self.trs)
